...
|xref:planned-trainroute-v2::api.adoc[] | Microservice 
|xref:personnel-staff-onboard::api.adoc[] | Microservice 
|xref:personnel-document-distribution-backend::api.adoc[] | Microservice 
|xref:rollingstock-pis-timetable-generator::api.adoc[] | Microservice 
|xref:personnel-train-staff-push::api.adoc[] | Microservice 
|xref:subscription::api.adoc[] | Microservice 
|xref:rollingstock-traingps::api.adoc[] | Microservice 
|xref:notification::api.adoc[] | Microservice 
|===
